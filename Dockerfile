...
RUN printf >/tmp/sourceme '%s\n'\
 ...
 'apk add neovim --update-cache --repository http://dl-6.alpinelinux.org/alpine/edge/testing/ --allow-untrusted'\
    ...
    'echo "apk"'\
    'printf "^%svim$\n" "" "initex." "java." "diff." "readline." "html." "lua." "python." "help." "markdown." "make." "json." "cmake." "automake." "matlab." "git." "syncolor." "cpp." "texmf." "config." "man." "manual." "conf." "Dockerfile." "godoc." "chaskell." "tex." "vim." "sh." "zsh." "perl." "texinfo." "c." "plaintex." "haskell." "go." "pod." "lhaskell." "gitcommit." "gitconfig." "tags." "master." "syntax." > /patterns'\
