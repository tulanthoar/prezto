...
RUN printf >/tmp/sourceme '%s\n'\
 ...
 'wget -O /tmp/pt.tar.gz https://github.com/monochromegane/the_platinum_searcher/releases/download/v2.1.4/pt_linux_amd64.tar.gz'\
 'tar -xzf /tmp/ptarch.tar.gz' 'mv /tmp/ptarch/pt /usr/local/bin/pt'\
