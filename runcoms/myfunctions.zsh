autoload -U l nvf colors unarchive _fzf_compgen_path writecmd fhe f fss fp fk fzf-locate-widget u md cm v z j p n h copyfile sudo-command-line c J nice_exit_code snippet-expand paste-primary
